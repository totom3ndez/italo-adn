...
import { $ as $$Layout, s as services } from './404_C30zw6VA.mjs';
...
const $$Index$1 = createComponent(async ($$result, $$props, $$slots) => {
  ...
  Astro2.self = $$Index$1;
  const posts = await Astro2.glob(/* #__PURE__ */ Object.assign({"./beneficios-ciudadania.mdx": () => import('./beneficios-ciudadania_BskCdwW-.mjs').then(n => n.d),"./carta-identidad.mdx": () => import('./carta-identidad_3h7HPET8.mjs'),"./certificado-no-naturalizacion.mdx": () => import('./certificado-no-naturalizacion_CMhasm39.mjs'),"./codice-fiscale.mdx": () => import('./codice-fiscale_BKGtR3LV.mjs'),"./declaracion-de-presencia.mdx": () => import('./declaracion-de-presencia_1jQmMK8M.mjs'),"./fijar-residencia.mdx": () => import('./fijar-residencia_AgP4FXi2.mjs').then(n => n.f),"./inscripcion-aire.mdx": () => import('./inscripcion-aire_Bu8RkcTC.mjs'),"./obtener-pasaporte-italiano.mdx": () => import('./obtener-pasaporte-italiano_dl_GhD2K.mjs'),"./paso-a-paso.mdx": () => import('./paso-a-paso_ztAgDAwJ.mjs'),"./rectificaciones.mdx": () => import('./rectificaciones_BUvNh3L6.mjs'),"./tessera-sanitaria.mdx": () => import('./tessera-sanitaria_DUtbpSeU.mjs'),"./via-judicial.mdx": () => import('./via-judicial_CSAPgAyR.mjs')}), () => "./*.mdx");
